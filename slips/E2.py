...
class Employee(Person, Company):
    ...
    def display_employee_info(self):
        ...
        return (f"{person_info}, {company_info}, Salary: {self.salary}, Skill: {self.skill}")

# Example usage
if __name__ == "__main__":
    # Create an Employee object
    employee = Employee(name="John Doe", age=30, cname="TechCorp", location="New York", salary=70000, skill="Python Development")
